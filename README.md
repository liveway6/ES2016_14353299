...
- ### **How to install**
  ...
  1. #### 安装必要环境：
     ...
     4. 安装jdk-8u101-linux-i586

        1. 解压安装包,将安装包解压到/usr/lib/java
  ...
  5. #### 编译DOL
     ...
     4. 进入build/bin/mian路径下并运行第一个例子
        ...
        运行成功的结果如下： ![successful](picture/successful.png)
